...
-- Name: autenticacion(character varying, character varying); Type: FUNCTION; Schema: public; Owner: edproj
--
...
ALTER FUNCTION public.autenticacion(_usuario character varying, _clave character varying) OWNER TO edproj;

--
-- TOC entry 204 (class 1255 OID 51568)
-- Name: comprar(smallint, smallint, smallint, smallint, smallint); Type: FUNCTION; Schema: public; Owner: edproj
--
...
ALTER FUNCTION public.comprar(_proveedor smallint, _producto smallint, _cantidad smallint, _valor smallint, _usuario smallint) OWNER TO edproj;

--
-- TOC entry 208 (class 1255 OID 51573)
-- Name: consulta_compras(smallint, smallint); Type: FUNCTION; Schema: public; Owner: edproj
--
...
ALTER FUNCTION public.consulta_compras(_limite smallint, _pagina smallint) OWNER TO edproj;
...
-- Name: productos; Type: TABLE; Schema: public; Owner: edproj; Tablespace: 
--
...
ALTER TABLE productos OWNER TO edproj;

--
-- TOC entry 209 (class 1255 OID 51574)
-- Name: consulta_inventario(smallint, smallint); Type: FUNCTION; Schema: public; Owner: edproj
--
...
ALTER FUNCTION public.consulta_inventario(_limite smallint, _pagina smallint) OWNER TO edproj;

--
-- TOC entry 199 (class 1255 OID 51562)
-- Name: consulta_productos(); Type: FUNCTION; Schema: public; Owner: edproj
--
...
ALTER FUNCTION public.consulta_productos() OWNER TO edproj;

--
-- TOC entry 177 (class 1259 OID 51465)
-- Name: terceros; Type: TABLE; Schema: public; Owner: edproj; Tablespace: 
--
...
ALTER TABLE terceros OWNER TO edproj;

--
-- TOC entry 200 (class 1255 OID 51561)
-- Name: consulta_terceros(); Type: FUNCTION; Schema: public; Owner: edproj
--
...
ALTER FUNCTION public.consulta_terceros() OWNER TO edproj;

--
-- TOC entry 207 (class 1255 OID 51572)
-- Name: consulta_ventas(smallint, smallint); Type: FUNCTION; Schema: public; Owner: edproj
--
...
ALTER FUNCTION public.consulta_ventas(_limite smallint, _pagina smallint) OWNER TO edproj;

--
-- TOC entry 203 (class 1255 OID 51566)
-- Name: tg_compras_auditoria(); Type: FUNCTION; Schema: public; Owner: edproj
--
...
ALTER FUNCTION public.tg_compras_auditoria() OWNER TO edproj;

--
-- TOC entry 202 (class 1255 OID 51564)
-- Name: tg_productos_auditoria(); Type: FUNCTION; Schema: public; Owner: edproj
--
...
ALTER FUNCTION public.tg_productos_auditoria() OWNER TO edproj;

--
-- TOC entry 205 (class 1255 OID 51569)
-- Name: tg_ventas_auditoria(); Type: FUNCTION; Schema: public; Owner: edproj
--
...
ALTER FUNCTION public.tg_ventas_auditoria() OWNER TO edproj;

--
-- TOC entry 206 (class 1255 OID 51571)
-- Name: vender(smallint, smallint, smallint, smallint); Type: FUNCTION; Schema: public; Owner: edproj
--
...
ALTER FUNCTION public.vender(_cliente smallint, _producto smallint, _cantidad smallint, _usuario smallint) OWNER TO edproj;

--
-- TOC entry 185 (class 1259 OID 51546)
-- Name: auditoria; Type: TABLE; Schema: public; Owner: edproj; Tablespace: 
--
...
ALTER TABLE auditoria OWNER TO edproj;

--
-- TOC entry 184 (class 1259 OID 51544)
-- Name: auditoria_id_auditoria_seq; Type: SEQUENCE; Schema: public; Owner: edproj
--
...
ALTER TABLE auditoria_id_auditoria_seq OWNER TO edproj;

--
-- TOC entry 2110 (class 0 OID 0)
-- Dependencies: 184
-- Name: auditoria_id_auditoria_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: edproj
--
...
-- Name: compras; Type: TABLE; Schema: public; Owner: edproj; Tablespace: 
--
...
ALTER TABLE compras OWNER TO edproj;

--
-- TOC entry 180 (class 1259 OID 51492)
-- Name: compras_id_compra_seq; Type: SEQUENCE; Schema: public; Owner: edproj
--
...
ALTER TABLE compras_id_compra_seq OWNER TO edproj;

--
-- TOC entry 2111 (class 0 OID 0)
-- Dependencies: 180
-- Name: compras_id_compra_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: edproj
--
...
-- Name: perfiles; Type: TABLE; Schema: public; Owner: edproj; Tablespace: 
--
...
ALTER TABLE perfiles OWNER TO edproj;

--
-- TOC entry 172 (class 1259 OID 51438)
-- Name: perfiles_id_perfil_seq; Type: SEQUENCE; Schema: public; Owner: edproj
--
...
ALTER TABLE perfiles_id_perfil_seq OWNER TO edproj;

--
-- TOC entry 2112 (class 0 OID 0)
-- Dependencies: 172
-- Name: perfiles_id_perfil_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: edproj
--
...
-- Name: productos_id_producto_seq; Type: SEQUENCE; Schema: public; Owner: edproj
--
...
ALTER TABLE productos_id_producto_seq OWNER TO edproj;

--
-- TOC entry 2113 (class 0 OID 0)
-- Dependencies: 178
-- Name: productos_id_producto_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: edproj
--
...
-- Name: terceros_id_tercero_seq; Type: SEQUENCE; Schema: public; Owner: edproj
--
...
ALTER TABLE terceros_id_tercero_seq OWNER TO edproj;

--
-- TOC entry 2114 (class 0 OID 0)
-- Dependencies: 176
-- Name: terceros_id_tercero_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: edproj
--
...
-- Name: usuarios; Type: TABLE; Schema: public; Owner: edproj; Tablespace: 
--
...
ALTER TABLE usuarios OWNER TO edproj;

--
-- TOC entry 174 (class 1259 OID 51448)
-- Name: usuarios_id_usuario_seq; Type: SEQUENCE; Schema: public; Owner: edproj
--
...
ALTER TABLE usuarios_id_usuario_seq OWNER TO edproj;

--
-- TOC entry 2115 (class 0 OID 0)
-- Dependencies: 174
-- Name: usuarios_id_usuario_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: edproj
--
...
-- Name: ventas; Type: TABLE; Schema: public; Owner: edproj; Tablespace: 
--
...
ALTER TABLE ventas OWNER TO edproj;

--
-- TOC entry 182 (class 1259 OID 51518)
-- Name: ventas_id_venta_seq; Type: SEQUENCE; Schema: public; Owner: edproj
--
...
ALTER TABLE ventas_id_venta_seq OWNER TO edproj;

--
-- TOC entry 2116 (class 0 OID 0)
-- Dependencies: 182
-- Name: ventas_id_venta_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: edproj
--
...
-- Name: id_auditoria; Type: DEFAULT; Schema: public; Owner: edproj
--
...
-- Name: id_compra; Type: DEFAULT; Schema: public; Owner: edproj
--
...
-- Name: id_perfil; Type: DEFAULT; Schema: public; Owner: edproj
--
...
-- Name: id_producto; Type: DEFAULT; Schema: public; Owner: edproj
--
...
-- Name: id_tercero; Type: DEFAULT; Schema: public; Owner: edproj
--
...
-- Name: id_usuario; Type: DEFAULT; Schema: public; Owner: edproj
--
...
-- Name: id_venta; Type: DEFAULT; Schema: public; Owner: edproj
--
...
-- Dependencies: 185
-- Data for Name: auditoria; Type: TABLE DATA; Schema: public; Owner: edproj
--
...
-- Dependencies: 184
-- Name: auditoria_id_auditoria_seq; Type: SEQUENCE SET; Schema: public; Owner: edproj
--
...
-- Dependencies: 181
-- Data for Name: compras; Type: TABLE DATA; Schema: public; Owner: edproj
--
...
-- Dependencies: 180
-- Name: compras_id_compra_seq; Type: SEQUENCE SET; Schema: public; Owner: edproj
--
...
-- Dependencies: 173
-- Data for Name: perfiles; Type: TABLE DATA; Schema: public; Owner: edproj
--
...
-- Dependencies: 172
-- Name: perfiles_id_perfil_seq; Type: SEQUENCE SET; Schema: public; Owner: edproj
--
...
-- Dependencies: 179
-- Data for Name: productos; Type: TABLE DATA; Schema: public; Owner: edproj
--
...
-- Dependencies: 178
-- Name: productos_id_producto_seq; Type: SEQUENCE SET; Schema: public; Owner: edproj
--
...
-- Dependencies: 177
-- Data for Name: terceros; Type: TABLE DATA; Schema: public; Owner: edproj
--
...
-- Dependencies: 176
-- Name: terceros_id_tercero_seq; Type: SEQUENCE SET; Schema: public; Owner: edproj
--
...
-- Dependencies: 175
-- Data for Name: usuarios; Type: TABLE DATA; Schema: public; Owner: edproj
--

INSERT INTO usuarios (id_usuario, usuario, nombre, clave, id_perfil) VALUES (1, 'dpumayauli', 'DANIEL PUMAYAULI', '2cbcd694efea34abdf2f1857595eaa17', 1);
...
-- Dependencies: 174
-- Name: usuarios_id_usuario_seq; Type: SEQUENCE SET; Schema: public; Owner: edproj
--
...
-- Dependencies: 183
-- Data for Name: ventas; Type: TABLE DATA; Schema: public; Owner: edproj
--
...
-- Dependencies: 182
-- Name: ventas_id_venta_seq; Type: SEQUENCE SET; Schema: public; Owner: edproj
--
...
-- Name: pk_auditoria; Type: CONSTRAINT; Schema: public; Owner: edproj; Tablespace: 
--
...
-- Name: pk_compras; Type: CONSTRAINT; Schema: public; Owner: edproj; Tablespace: 
--
...
-- Name: pk_perfiles; Type: CONSTRAINT; Schema: public; Owner: edproj; Tablespace: 
--
...
-- Name: pk_productos; Type: CONSTRAINT; Schema: public; Owner: edproj; Tablespace: 
--
...
-- Name: pk_terceros; Type: CONSTRAINT; Schema: public; Owner: edproj; Tablespace: 
--
...
-- Name: pk_usuarios; Type: CONSTRAINT; Schema: public; Owner: edproj; Tablespace: 
--
...
-- Name: pk_ventas; Type: CONSTRAINT; Schema: public; Owner: edproj; Tablespace: 
--
...
-- Name: uk_perfiles; Type: CONSTRAINT; Schema: public; Owner: edproj; Tablespace: 
--
...
-- Name: uk_productos; Type: CONSTRAINT; Schema: public; Owner: edproj; Tablespace: 
--
...
-- Name: uk_terceros; Type: CONSTRAINT; Schema: public; Owner: edproj; Tablespace: 
--
...
-- Name: uk_usuarios; Type: CONSTRAINT; Schema: public; Owner: edproj; Tablespace: 
--
...
-- Name: tg_compras_auditoria; Type: TRIGGER; Schema: public; Owner: edproj
--
...
-- Name: tg_productos_auditoria; Type: TRIGGER; Schema: public; Owner: edproj
--
...
-- Name: tg_ventas_auditoria; Type: TRIGGER; Schema: public; Owner: edproj
--
...
-- Name: fk_auditoria_usuarios; Type: FK CONSTRAINT; Schema: public; Owner: edproj
--
...
-- Name: fk_compras_productos; Type: FK CONSTRAINT; Schema: public; Owner: edproj
--
...
-- Name: fk_compras_terceros; Type: FK CONSTRAINT; Schema: public; Owner: edproj
--
...
-- Name: fk_compras_usuarios; Type: FK CONSTRAINT; Schema: public; Owner: edproj
--
...
-- Name: fk_productos_usuarios; Type: FK CONSTRAINT; Schema: public; Owner: edproj
--
...
-- Name: fk_usuarios_perfiles; Type: FK CONSTRAINT; Schema: public; Owner: edproj
--
...
-- Name: fk_ventas_productos; Type: FK CONSTRAINT; Schema: public; Owner: edproj
--
...
-- Name: fk_ventas_terceros; Type: FK CONSTRAINT; Schema: public; Owner: edproj
--
...
-- Name: fk_ventas_usuario; Type: FK CONSTRAINT; Schema: public; Owner: edproj
--
